    ...
    return (
        <div className="relative w-[20.5%] group/whole">
            ...
            <div className="absolute top-full left-0 p-2 border border-borderColor bg-bgColor hidden group-hover/whole:block">
                ...
                <Link rel="noopener noreferrer" to="/" target="_blank" className="inline-block w-full px-3 py-4 cst-link-item-bg mb-3 opacity-60 hover:opacity-100 duration-150" >
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center mr-3">
                            <img src="/assets/images/logo.webp" alt="" className="mr-1" width={32} height={32} />
                            <p className="text-xl">
                ...
                <Link rel="noopener noreferrer" to="/" target="_blank" className="inline-block w-full px-3 py-4 cst-link-item-bg opacity-60 hover:opacity-100 duration-150" >
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center mr-3">
                            <img src="/assets/images/logo.webp" alt="" className="mr-1" width={32} height={32} />
                            <p className="text-xl">
