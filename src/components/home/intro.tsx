...
export default function Intro() {
    return (
        <ContainerBig>
                ...
                <div className="py-32 flex items-stretch">
                    <div className="w-1/2 text-lg relative">
                        ...
                        <div className="h-full border border-white p-5 relative">
                            <p className="mb-2">
                                Safety and security should be at the heart of all
                                platforms, especially public goods services.
                            </p>
                            <p className="mb-2">
                                which is why we are passionate about providing
                                technical support and high level security integration
                                for projects from all blockchains and backgrounds.
                            </p>
                            <p>
            ...
            <ContainerSmall className="flex mt-8 mb-16">
                <div className="w-1/2 px-4">
                    ...
                    <div className="mt-12 rounded border border-gray-500 p-4 bg-[#0F0F14]">
                        <div className="flex justify-between items-center mb-3">
                            <img src="/assets/images/logo.png" alt="logo" width={48} />
                            <p className="text-xl">Become a WHD Member</p>
                            <span className="px-4 py-1 border border-gray-600 text-sm">FREE</span>
                        </div>
                        <div className="mb-3">
                            <p className="text-lg">MEMBERSHIP NFT</p>
                            <p className="text-sm">Network: Polygon</p>
                        </div>
                        <div className="flex items-center justify-between">
                            <div>
                                <span className="bg-green-500 p-1 text-sm mr-2">Verified</span>
                                <span className="bg-light-blue-500 p-1 text-sm mr-2">Forum Discussion</span>
                                <span className="bg-deep-purple-500 p-1 text-sm">Governance Access</span>
                            </div>
                            <span className="flex items-center p-1 bg-gray-600 rounded cursor-pointer">
