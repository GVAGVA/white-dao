...
export default function Footer() {
    return (
        <div className="bg-bgColor relative z-[99]">
            ...
            <ContainerBig className="border-x border-borderColor py-8">
                <div className="flex">
                    <div className="w-[14.8vw] pl-[4vw]">
                        <img src="/assets/images/logo.webp" alt="" className="w-14" />
                    </div>
                    <div className="w-[66vw]">
                        <p className="text-white mb-10 w-1/2">We want to make it easy for everyone to embrace the web3 ecosystem in a secure, decentralized and future-proof way. Join us in this Journey.</p>
